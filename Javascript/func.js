//Javascript for the HOME section only
...
function dropdown() {
  ...
  if (navbar.className === "topnav") {
    ...
    document.getElementById("h1").style.margin = "450px auto 0 auto";
    document.getElementById("contact_ico").style.display = "block";
    ...
    document.getElementById("h1").style.margin = "100px auto 0 auto";
    document.getElementById("contact_ico").style.display = "none";
    document.getElementById("contact_ico").style.display = "none";
